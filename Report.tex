...
\textsc{\large Placement Year - CI282}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Reflective Report}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Supervisor:} \\
Dr. Emmanouil \textsc{Panaousis} % Supervisor's Name (Manos)
\end{flushright}
\end{minipage}\\[3cm]
...
{\large Hand in Date : 09\textsuperscript{th} of May}\\[2cm] % Date, change the \today to a set date if you want to be precise
